...
//     }
//     check_cuda(cudaMalloc(&d_workspace_a, max_num_layers * sizeof(float)), "alloc d_ws_a");
//     check_cuda(cudaMalloc(&d_workspace_b, max_num_layers * sizeof(float)), "alloc d_ws_b");
...
int main(int argc, char** argv) {
    ...
    check_cuda(cudaMalloc(&d_workspace_a, max_workspace_bytes), "alloc d_ws_a");
    check_cuda(cudaMalloc(&d_workspace_b, max_workspace_bytes), "alloc d_ws_b");
